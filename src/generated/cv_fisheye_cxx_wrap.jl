...
function fisheye_calibrate(objectPoints::Array{InputArray, 1}, imagePoints::Array{InputArray, 1}, image_size::Size{Int32}, K::InputArray, D::InputArray, rvecs::Array{InputArray, 1}, tvecs::Array{InputArray, 1}, flags::Int64, criteria::TermCriteria)
...
fisheye_calibrate(objectPoints::Array{InputArray, 1}, imagePoints::Array{InputArray, 1}, image_size::Size{Int32}, K::InputArray, D::InputArray; rvecs::Array{InputArray, 1} = (Array{InputArray, 1}()), tvecs::Array{InputArray, 1} = (Array{InputArray, 1}()), flags::Int64 = Int64(0), criteria::TermCriteria = (TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP)) = fisheye_calibrate(objectPoints, imagePoints, image_size, K, D, rvecs, tvecs, flags, criteria)
...
function fisheye_stereoCalibrate(objectPoints::Array{InputArray, 1}, imagePoints1::Array{InputArray, 1}, imagePoints2::Array{InputArray, 1}, K1::InputArray, D1::InputArray, K2::InputArray, D2::InputArray, imageSize::Size{Int32}, R::InputArray, T::InputArray, rvecs::Array{InputArray, 1}, tvecs::Array{InputArray, 1}, flags::Int64, criteria::TermCriteria)
...
fisheye_stereoCalibrate(objectPoints::Array{InputArray, 1}, imagePoints1::Array{InputArray, 1}, imagePoints2::Array{InputArray, 1}, K1::InputArray, D1::InputArray, K2::InputArray, D2::InputArray, imageSize::Size{Int32}; R::InputArray = (CxxMat()), T::InputArray = (CxxMat()), rvecs::Array{InputArray, 1} = (Array{InputArray, 1}()), tvecs::Array{InputArray, 1} = (Array{InputArray, 1}()), flags::Int64 = Int64(cv_fisheye_CALIB_FIX_INTRINSIC), criteria::TermCriteria = (TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP)) = fisheye_stereoCalibrate(objectPoints, imagePoints1, imagePoints2, K1, D1, K2, D2, imageSize, R, T, rvecs, tvecs, flags, criteria)

function fisheye_stereoCalibrate(objectPoints::Array{InputArray, 1}, imagePoints1::Array{InputArray, 1}, imagePoints2::Array{InputArray, 1}, K1::InputArray, D1::InputArray, K2::InputArray, D2::InputArray, imageSize::Size{Int32}, R::InputArray, T::InputArray, flags::Int64, criteria::TermCriteria)
