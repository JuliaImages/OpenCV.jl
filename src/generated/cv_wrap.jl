    ...
    const AKAZE_DESCRIPTOR_KAZE = OpenCV.cv_AKAZE_DESCRIPTOR_KAZE
    const AKAZE_DESCRIPTOR_KAZE_UPRIGHT = OpenCV.cv_AKAZE_DESCRIPTOR_KAZE_UPRIGHT
    const AKAZE_DESCRIPTOR_MLDB = OpenCV.cv_AKAZE_DESCRIPTOR_MLDB
    const AKAZE_DESCRIPTOR_MLDB_UPRIGHT = OpenCV.cv_AKAZE_DESCRIPTOR_MLDB_UPRIGHT
    ...
    const AgastFeatureDetector_AGAST_5_8 = OpenCV.cv_AgastFeatureDetector_AGAST_5_8
    const AGAST_FEATURE_DETECTOR_AGAST_5_8 = OpenCV.cv_AGAST_FEATURE_DETECTOR_AGAST_5_8;
    const AgastFeatureDetector_AGAST_7_12d = OpenCV.cv_AgastFeatureDetector_AGAST_7_12d
    const AGAST_FEATURE_DETECTOR_AGAST_7_12D = OpenCV.cv_AGAST_FEATURE_DETECTOR_AGAST_7_12D;
    const AgastFeatureDetector_AGAST_7_12s = OpenCV.cv_AgastFeatureDetector_AGAST_7_12s
    const AGAST_FEATURE_DETECTOR_AGAST_7_12S = OpenCV.cv_AGAST_FEATURE_DETECTOR_AGAST_7_12S;
    const AgastFeatureDetector_NONMAX_SUPPRESSION = OpenCV.cv_AgastFeatureDetector_NONMAX_SUPPRESSION
    const AGAST_FEATURE_DETECTOR_NONMAX_SUPPRESSION = OpenCV.cv_AGAST_FEATURE_DETECTOR_NONMAX_SUPPRESSION;
    const AgastFeatureDetector_OAST_9_16 = OpenCV.cv_AgastFeatureDetector_OAST_9_16
    const AGAST_FEATURE_DETECTOR_OAST_9_16 = OpenCV.cv_AGAST_FEATURE_DETECTOR_OAST_9_16;
    const AgastFeatureDetector_THRESHOLD = OpenCV.cv_AgastFeatureDetector_THRESHOLD
    const AGAST_FEATURE_DETECTOR_THRESHOLD = OpenCV.cv_AGAST_FEATURE_DETECTOR_THRESHOLD;
    ...
    const DescriptorMatcher_BRUTEFORCE = OpenCV.cv_DescriptorMatcher_BRUTEFORCE
    const DESCRIPTOR_MATCHER_BRUTEFORCE = OpenCV.cv_DESCRIPTOR_MATCHER_BRUTEFORCE;
    const DescriptorMatcher_BRUTEFORCE_HAMMING = OpenCV.cv_DescriptorMatcher_BRUTEFORCE_HAMMING
    const DESCRIPTOR_MATCHER_BRUTEFORCE_HAMMING = OpenCV.cv_DESCRIPTOR_MATCHER_BRUTEFORCE_HAMMING;
    const DescriptorMatcher_BRUTEFORCE_HAMMINGLUT = OpenCV.cv_DescriptorMatcher_BRUTEFORCE_HAMMINGLUT
    const DESCRIPTOR_MATCHER_BRUTEFORCE_HAMMINGLUT = OpenCV.cv_DESCRIPTOR_MATCHER_BRUTEFORCE_HAMMINGLUT;
    const DescriptorMatcher_BRUTEFORCE_L1 = OpenCV.cv_DescriptorMatcher_BRUTEFORCE_L1
    const DESCRIPTOR_MATCHER_BRUTEFORCE_L1 = OpenCV.cv_DESCRIPTOR_MATCHER_BRUTEFORCE_L1;
    const DescriptorMatcher_BRUTEFORCE_SL2 = OpenCV.cv_DescriptorMatcher_BRUTEFORCE_SL2
    const DESCRIPTOR_MATCHER_BRUTEFORCE_SL2 = OpenCV.cv_DESCRIPTOR_MATCHER_BRUTEFORCE_SL2;
    const DescriptorMatcher_FLANNBASED = OpenCV.cv_DescriptorMatcher_FLANNBASED
    const DESCRIPTOR_MATCHER_FLANNBASED = OpenCV.cv_DESCRIPTOR_MATCHER_FLANNBASED;
    const DrawMatchesFlags_DEFAULT = OpenCV.cv_DrawMatchesFlags_DEFAULT
    const DRAW_MATCHES_FLAGS_DEFAULT = OpenCV.cv_DRAW_MATCHES_FLAGS_DEFAULT;
    const DrawMatchesFlags_DRAW_OVER_OUTIMG = OpenCV.cv_DrawMatchesFlags_DRAW_OVER_OUTIMG
    const DRAW_MATCHES_FLAGS_DRAW_OVER_OUTIMG = OpenCV.cv_DRAW_MATCHES_FLAGS_DRAW_OVER_OUTIMG;
    const DrawMatchesFlags_DRAW_RICH_KEYPOINTS = OpenCV.cv_DrawMatchesFlags_DRAW_RICH_KEYPOINTS
    const DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS = OpenCV.cv_DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS;
    const DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS = OpenCV.cv_DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS
    const DRAW_MATCHES_FLAGS_NOT_DRAW_SINGLE_POINTS = OpenCV.cv_DRAW_MATCHES_FLAGS_NOT_DRAW_SINGLE_POINTS;
    ...
    const FastFeatureDetector_FAST_N = OpenCV.cv_FastFeatureDetector_FAST_N
    const FAST_FEATURE_DETECTOR_FAST_N = OpenCV.cv_FAST_FEATURE_DETECTOR_FAST_N;
    const FastFeatureDetector_NONMAX_SUPPRESSION = OpenCV.cv_FastFeatureDetector_NONMAX_SUPPRESSION
    const FAST_FEATURE_DETECTOR_NONMAX_SUPPRESSION = OpenCV.cv_FAST_FEATURE_DETECTOR_NONMAX_SUPPRESSION;
    const FastFeatureDetector_THRESHOLD = OpenCV.cv_FastFeatureDetector_THRESHOLD
    const FAST_FEATURE_DETECTOR_THRESHOLD = OpenCV.cv_FAST_FEATURE_DETECTOR_THRESHOLD;
    const FastFeatureDetector_TYPE_5_8 = OpenCV.cv_FastFeatureDetector_TYPE_5_8
    const FAST_FEATURE_DETECTOR_TYPE_5_8 = OpenCV.cv_FAST_FEATURE_DETECTOR_TYPE_5_8;
    const FastFeatureDetector_TYPE_7_12 = OpenCV.cv_FastFeatureDetector_TYPE_7_12
    const FAST_FEATURE_DETECTOR_TYPE_7_12 = OpenCV.cv_FAST_FEATURE_DETECTOR_TYPE_7_12;
    const FastFeatureDetector_TYPE_9_16 = OpenCV.cv_FastFeatureDetector_TYPE_9_16
    const FAST_FEATURE_DETECTOR_TYPE_9_16 = OpenCV.cv_FAST_FEATURE_DETECTOR_TYPE_9_16;
    ...
    const KAZE_DIFF_CHARBONNIER = OpenCV.cv_KAZE_DIFF_CHARBONNIER
    const KAZE_DIFF_PM_G1 = OpenCV.cv_KAZE_DIFF_PM_G1
    const KAZE_DIFF_PM_G2 = OpenCV.cv_KAZE_DIFF_PM_G2
    const KAZE_DIFF_WEICKERT = OpenCV.cv_KAZE_DIFF_WEICKERT
    ...
    const ORB_FAST_SCORE = OpenCV.cv_ORB_FAST_SCORE
    const ORB_HARRIS_SCORE = OpenCV.cv_ORB_HARRIS_SCORE
